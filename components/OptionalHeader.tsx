...
const OptionalHeader = ({ children }: OptionalHeaderProp) => {
  ...
  return (
    <header
      className={`flex flex-col px-[200px] py-5 items-center self-stretch h-[92px] gap-2 z-10 bg-light-blue 1920px:w-full 1920px:px-calc-1 1920px:overflow-hidden 1199px:px-calc-2 869px:px-8 767px:py-[13px] ${
